...
export default function App() {
  ...
  // Add Task Modal Component with translucent, blurred background for light theme
  function AddTaskModal({ onClose }) {
    ...
    // Modal style: translucent white with blur
    const modalBackgroundClass =
      theme === "dark"
        ? "bg-slate-800"
        : "bg-white bg-opacity-30 backdrop-blur-md";

    const modalTextClass = theme === "dark" ? "text-gray-200" : "text-gray-800";
    ...
    return (
      ...
      >
        <div
          className={`${modalBackgroundClass} rounded-2xl w-full max-w-md p-6 shadow-lg border border-gray-300`}
          style={{ boxShadow: neonBoxShadow }}
        >
          <div className="flex justify-between items-center mb-4">
            <h3 className={`text-lg font-semibold ${modalTextClass}`}>Add Task</h3>
            <button
              onClick={onClose}
              className={`${modalTextClass} font-bold text-xl hover:text-white`}
            ...
            return (
              ...
              >
                <div className="flex justify-between items-center mb-3">
                  <h2 className="font-semibold text-gray-300">{label}</h2>
                  <div className="text-xs font-semibold text-gray-200 bg-gray-700 rounded px-2 py-0.5 select-none">
                    {count}
                  </div>
                </div>
