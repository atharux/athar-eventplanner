    ...
    return (
      <div className="space-y-4">
        ...
        <div className="panel-glass glass-border rounded-md p-8 text-center">
          <p className="text-sm" style={{ color: 'var(--text-2)' }}>No pre-flight report is available for this event yet.</p>
          <p className="text-xs mt-2" style={{ color: 'var(--text-3)' }}>
            Reports are generated by the constraint engine before each event — ask your organizer to publish one.
          </p>
        </div>
      </div>
    );
